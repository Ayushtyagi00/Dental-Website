...
if(!isset($_SESSION["userid"]))
{
    ...
    if (isset($_POST["make_appoinment"]))
    {
        ...
        $test_name = $_POST['procedure'];
        $appoinment_date = date('Y-m-d', strtotime($_POST['appointment_date']));
        $appoinment_time = $_POST['appointment_time'];

        $qry = "INSERT INTO booked_appoinment(user_id, first_name, last_name, DOB_day, DOB_month, DOB_year, gender, phone_number, address, district, city, state, zip_code, email, confirm_email, test_name, appoinment_date, appoinment_time) VALUES ('$user_id', '$first_name', '$last_name', '$DOB_day', '$DOB_month', '$DOB_year', '$gender', '$phone_number', '$address', '$district', '$city', '$state', '$zip_code', '$email', '$confirm_email', '$test_name', '$appoinment_date', '$appoinment_time')";
